...
(function(){
  ...
  if(!loader) { try{document.body.classList.remove('no-scroll');}catch(e){} return; }
  function hide(){
    ...
    setTimeout(function(){ try{ loader.parentNode && loader.parentNode.removeChild(loader);}catch(e){} }, 500);
  }
  if(document.readyState==='complete' || document.readyState==='interactive'){ setTimeout(hide, 200); }
  else { document.addEventListener('DOMContentLoaded', function(){ setTimeout(hide, 200); }, { once: true }); }
